...
namespace RP
{
    public class Meth : Script
    {
        Vector2 World3DToScreen2d(Vector3 pos)
        {
            ...
            Function.Call<bool>((Hash)0x34E82F05DF2974F5, pos.X, pos.Y, pos.Z, x2dp, y2dp);
        ...
        private static bool perk8methlabguards = true;
        ...
        private static int perk8price = 1000000;
        ...
        {
            foreach (MethLabGuard P in MethLabGuards)
            {
                if (P != null)
                {
                    if (P.Guard != null)
        ...
        public void cookMenu(LemonUI.Menus.NativeMenu menu)
        {
            ...
            var cookmethbigitemx2 = new LemonUI.Menus.NativeItem("Start cooking extremely large batch", "This requires 150x supplies.");
            cookMenu.Add(cookmethbigitemx2);
            var cookmethbigitemx3 = new LemonUI.Menus.NativeItem("Start cooking mega batch", "This requires 500x supplies.");
            cookMenu.Add(cookmethbigitemx3);
            var cookmethbigitemx4= new LemonUI.Menus.NativeItem("Start cooking ultimate batch", "This requires 1000x supplies.");
            cookMenu.Add(cookmethbigitemx4);
            ...
            cookmethbigbigitem.Activated += (sender, item) =>
            {
                ...
                else
                {
                    ...
                    {
                        BatchType = 1;
                        cookmethverylarge(50);
                    }
                }
            };
            cookmethbigitemx2.Activated += (sender, item) =>
            {
                if (Game.Player.Character.Position.DistanceTo(Meth.Lab_LiquorAce) > 3.5 && perk1chef == false)
                {
                    Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "OTHER_TEXT", "HUD_AWARDS");
                ...
                else
                {
                    ...
                    {
                        Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "OTHER_TEXT", "HUD_AWARDS");
                        GTA.UI.Notification.Show("~r~You need at least ~b~150x supplies~r~, please purchase more and try again.");
                    }
                    else
                    {
                        BatchType = 2;
                        cookmethverylarge(150);
                    }
                }
            };
            cookmethbigitemx3.Activated += (sender, item) =>
            {
                if (Game.Player.Character.Position.DistanceTo(Meth.Lab_LiquorAce) > 3.5 && perk1chef == false)
                {
                    Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "OTHER_TEXT", "HUD_AWARDS");
                ...
                else
                {
                    ...
                    {
                        Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "OTHER_TEXT", "HUD_AWARDS");
                        GTA.UI.Notification.Show("~r~You need at least ~b~500x supplies~r~, please purchase more and try again.");
                    }
                    else
                    {
                        BatchType = 3;
                        cookmethverylarge(500);
                    }
                }
            };
            cookmethbigitemx4.Activated += (sender, item) =>
            {
                if (Game.Player.Character.Position.DistanceTo(Meth.Lab_LiquorAce) > 3.5 && perk1chef == false)
                {
                    Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "OTHER_TEXT", "HUD_AWARDS");
                ...
                else
                {
                    ...
                    {
                        Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "OTHER_TEXT", "HUD_AWARDS");
                        GTA.UI.Notification.Show("~r~You need at least ~b~1000x supplies~r~, please purchase more and try again.");
                    }
                    else
                    {
                        BatchType = 4;
                        cookmethverylarge(100);
                    }
                }
            };
        ...
        public void suppliesMenu(LemonUI.Menus.NativeMenu menu)
        {
            ...
            getSuppliesItem.Activated += (sender, item) =>
            {
                if (Meth.OnSupply == 0)
                {
                    currentSupplyDeal = SuppliesAmt[getSuppliesItem.SelectedIndex];
        ...
        public void perkMenu(LemonUI.Menus.NativeMenu menu)
        {
            ...
            var perk8hireguardsItem = new LemonUI.Menus.NativeCheckboxItem("Hire Guards", "Hire some guards to automatically defend your meth lab against raids. Costs ~g~$" + perk8price + ".");
            perkMenu.Add(perk8hireguardsItem); perk8hireguardsItem.Checked = perk8methlabguards;
            ...
            perk8hireguardsItem.Activated += (sender, item) =>
            {
                if (perkMenu.SelectedIndex == 7)
                {
                    if (Game.Player.Money >= perk8price)
                    {
                        Game.Player.Money -= perk8price;
                        perk8methlabguards = perk8hireguardsItem.Checked;
                        if (perk8methlabguards)
                        {
                            foreach (MethLabGuard P in MethLabGuards)
                            {
                                if (P != null)
                            ...
                            CreatedmethlabGuards = false;

                            GTA.UI.Notification.Show("'Hire Guards' perk has been ~g~activated.");
                            saveStats();
                            Function.Call(Hash.PLAY_SOUND_FRONTEND, -1, "CONFIRM_BEEP", "HUD_MINI_GAME_SOUNDSET");
                        }
                    }
                ...
                {
                    perk8methlabguards = false;
                    GTA.UI.Notification.Show("'Hire Guards' perk has been ~r~deactivated.");
                    foreach (MethLabGuard P in MethLabGuards)
                    {
                        if (P != null)
                        {
        ...
        public static void saveStats()
        {
            if (saveToggle == 1)
            {
                try
                {
                    ...
                    Config.SetValue<bool>("Perks", "perk8methlabguards", perk8methlabguards);

                    Config.SetValue<int>("Supplies", "Supplies", currentSupplies);
                    Config.SetValue<int>("Grams", "CurrentGrams", currentGrams);
                    Config.SetValue<int>("Grams", "CurrentDealGrams", currentDealGrams);
                    Config.SetValue<int>("UPGRADES", "Upgrades", upgradeCount);
        ...
        public static void loadStats()
        {
            try
            {
                ...
                currentSupplies= Config.GetValue<int>("Supplies", "Supplies", currentSupplies);
                currentGrams= Config.GetValue<int>("Grams", "CurrentGrams", currentGrams);
                currentDealGrams = Config.GetValue<int>("Grams", "CurrentDealGrams", currentDealGrams);
                perk8methlabguards= Config.GetValue<bool>("Perks", "perk8methlabguards", perk8methlabguards);
                upgradeCount=Config.GetValue<int>("UPGRADES", "Upgrades", upgradeCount);
            }
            catch
            {
        ...
        public static void autoBatchTimer()
        {
            if (Meth.largeBatchStart == 1 || Meth.smallBatchStart == 1 || Meth.large2BatchStart == 1)
            {
                ...
                if (Meth.large2BatchStart == 1)
                {
                    ...
                    if (BatchType == 2)
                    {
                        tmpSF.CallFunction("SET_PLAYER_NAME", "Cooking extremely large batch - ~g~" + percent.ToString() + "%");
                    }
                    if (BatchType == 3)
                    {
                        tmpSF.CallFunction("SET_PLAYER_NAME", "Cooking mega batch - ~g~" + percent.ToString() + "%");
                    }
                    if (BatchType == 4)
                    {
                        tmpSF.CallFunction("SET_PLAYER_NAME", "Cooking ultimate batch - ~g~" + percent.ToString() + "%");
                    }
                    ...
                    if (Meth.TimerCounterAutoBatch >= Meth.TimerTarget)
                    {
                        ...
                        {
                            Meth.large2BatchStart = 0;
                            autoBatchFinished("elarge");
                        }
                        if (BatchType == 3)
                        {
                            Meth.large2BatchStart = 0;
                            autoBatchFinished("mlarge");
                        }
                        if (BatchType == 4)
                        {
                            Meth.large2BatchStart = 0;
                            autoBatchFinished("ularge");
                        }
        ...
        public static void DoSupplier()
        {
            try
            {
                ...
                if (Meth.Supplier == 1)
                {
                    ...
                    Meth.supply1ped1.Task.StartScenario("WORLD_HUMAN_SMOKING", Meth.supply1ped1.Position.Z);
                    Meth.supply1ped2.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER", Meth.supply1ped2.Position.Z);
                    Meth.supply1ped3.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.supply1ped3.Position.Z);
                    Meth.supply1ped4.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER_HARD", Meth.supply1ped4.Position.Z);
        ...
        public static void DoSupplierLarge()
        {
            try
            {
                ...
                if (Meth.Supplier == 100)
                {
                    ...
                    Meth.supply100vehicle3 = GTA.World.CreateVehicle(RequestModel(-877478386), new GTA.Math.Vector3(1767.907f, 3308.549f, 43.02583f), -102.0172f);
                    Meth.supply100vehicle4 = GTA.World.CreateVehicle(RequestModel(569305213), new GTA.Math.Vector3(1774.955f, 3305.573f, 41.30701f), -129.401f);
                    Meth.supply100vehicle5 = GTA.World.CreateVehicle(RequestModel(-120287622), new GTA.Math.Vector3(1716.777f, 3320.531f, 40.70575f), 30.61937f);
                    Meth.supply100vehicle6 = GTA.World.CreateVehicle(RequestModel(410882957), new GTA.Math.Vector3(1726.479f, 3304.167f, 40.96267f), -4.331663f);
                    Meth.supply100ped1 = GTA.World.CreatePed(RequestModel(-236444766), new GTA.Math.Vector3(1731.161f, 3308.914f, 41.22349f), -164.9982f); //Arm ped
                    Meth.supply100ped2 = GTA.World.CreatePed(RequestModel(-984709238), new GTA.Math.Vector3(1778.127f, 3308.93f, 41.26607f), 92.54225f);
                    Meth.supply100ped3 = GTA.World.CreatePed(RequestModel(62440720), new GTA.Math.Vector3(1776.895f, 3308.578f, 41.23178f), -69.25532f);
                    Meth.supply100ped4 = GTA.World.CreatePed(RequestModel(653210662), new GTA.Math.Vector3(1736.572f, 3310.279f, 41.22349f), 163.8191f);
                    Meth.supply100ped5 = GTA.World.CreatePed(RequestModel(832784782), new GTA.Math.Vector3(1725.642f, 3295.243f, 41.22349f), -30.87549f);
                    Meth.supply100ped6 = GTA.World.CreatePed(RequestModel(846439045), new GTA.Math.Vector3(1726.019f, 3295.729f, 41.22349f), 128.3713f);
                    Meth.supply100ped7 = GTA.World.CreatePed(RequestModel(1329576454), new GTA.Math.Vector3(1730.227f, 3309.128f, 41.22349f), -151.9981f);
                    Meth.supply100ped8 = GTA.World.CreatePed(RequestModel(2119136831), new GTA.Math.Vector3(1777.576f, 3309.768f, 41.24263f), 154.998f);
                    Meth.supply100ped9 = GTA.World.CreatePed(RequestModel(275618457), new GTA.Math.Vector3(1731.974f, 3309.317f, 41.22349f), 175.4975f);
                    Meth.supply100ped10 = GTA.World.CreatePed(RequestModel(-424905564), new GTA.Math.Vector3(1727.745f, 3303.862f, 41.22349f), -85.69844f);
                ...
                {
                    supply101_p1 = 1;
                    Meth.supply101vehicle1 = GTA.World.CreateVehicle(RequestModel(1353720154), new GTA.Math.Vector3(916.9577f, 3227.12f, 37.77361f), -84.85264f); //Main flatbed
                    Meth.supply101vehicle2 = GTA.World.CreateVehicle(RequestModel(-1050465301), new GTA.Math.Vector3(914.8985f, 3212.09f, 38.23495f), -33.28543f);
                    Meth.supply101vehicle3 = GTA.World.CreateVehicle(RequestModel(-1122289213), new GTA.Math.Vector3(879.5189f, 3209.515f, 38.36486f), -34.30712f);
                    Meth.supply101vehicle4 = GTA.World.CreateVehicle(RequestModel(833469436), new GTA.Math.Vector3(929.3218f, 3217.77f, 38.33878f), 95.20866f);

                    Vector3 rot = new GTA.Math.Vector3(1388.729f, 3613.192f, 42.63286f);
                    Model model = RequestModel(90805875);
                    model.Request(10000);
                    ...
                    AttachEntityToEntity(supply101crate1, supply101vehicle1, supply101vehicle1.Bones["bodyshell"].Index, new Vector3(0f, 0f, 1f), new Vector3(0f, 0f, 0f), false, false, false, 2, true);

                    rot = new GTA.Math.Vector3(1388.729f, 3613.192f, 42.63286f);
                    model = RequestModel(90805875);
                    model.Request(10000);
                    ...
                    AttachEntityToEntity(supply101crate2, supply101vehicle1, supply101vehicle1.Bones["bodyshell"].Index, new Vector3(0f, -1.56f, 0.98f), new Vector3(0f, 0f, 2.5f), false, false, false, 2, true);
                    ...
                    AttachEntityToEntity(supply101crate3, supply101vehicle1, supply101vehicle1.Bones["bodyshell"].Index, new Vector3(0f, -3.06f, 0.98f), new Vector3(0f, 0f, 0f), false, false, false, 2, true);


                    Meth.supply101ped1 = GTA.World.CreatePed(RequestModel(-245247470), new GTA.Math.Vector3(915.8012f, 3216.68f, 37.80977f), 21.00023f); //Boss ped
                    Meth.supply101ped2 = GTA.World.CreatePed(RequestModel(1142162924), new GTA.Math.Vector3(878.3032f, 3210.423f, 38.94556f), 37.99935f);
                    Meth.supply101ped3 = GTA.World.CreatePed(RequestModel(-1105135100), new GTA.Math.Vector3(914.9085f, 3215.062f, 37.92984f), 49.45645f);
                    Meth.supply101ped4 = GTA.World.CreatePed(RequestModel(32417469), new GTA.Math.Vector3(917.3062f, 3216.241f, 37.97442f), 42.12531f);
                    Meth.supply101ped5 = GTA.World.CreatePed(RequestModel(1161072059), new GTA.Math.Vector3(928.9919f, 3219.239f, 38.72077f), 1.991193f);
                    Meth.supply101ped6 = GTA.World.CreatePed(RequestModel(-9308122), new GTA.Math.Vector3(901.8941f, 3214.551f, 39.04514f), 6.779407f);

                    Meth.supply101ped2.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER", Meth.supply101ped2.Position.Z);
                    Meth.supply101ped5.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER_HARD", Meth.supply101ped5.Position.Z);
                ...
                if (Meth.Supplier == 102)
                {
                    ...
                    if (truckrandom == 1)
                    {
                        Meth.supply102vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(2487.655f, 4122.348f, 38.34645f), 154.6222f);
                    }
                    else if (truckrandom == 2)
                    {
                        Meth.supply102vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(896.7539f, 3649.353f, 33.01156f), 91.50149f);
                    }
                    else if (truckrandom == 3)
                    {
                        Meth.supply102vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(461.9666f, 3548.505f, 33.47028f), 74.92836f);
                    }
                    else if (truckrandom == 4)
                    {
                        Meth.supply102vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(393.7837f, 3589.432f, 33.52397f), -98.03756f);
                    }
                    else if (truckrandom == 5)
                    {
                        Meth.supply102vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(432.5303f, 3518.944f, 34.00178f), 101.7411f);
                    }
                    else if (truckrandom == 6)
                    {
                        Meth.supply102vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(1892.821f, 3704.923f, 33.1071f), 122.041f);
                    }
                    else
                    {
                        Meth.supply102vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(1966.596f, 3853.509f, 32.23496f), -148.5567f);
                    }
                ...
                if (Meth.Supplier == 103)
                {
                    ...
                    if (trailerrandom == 1)
                    {
                        Meth.supply103vehicle1 = GTA.World.CreateVehicle(RequestModel(-877478386), new GTA.Math.Vector3(1767.442f, 3307.859f, 43.15251f), -136.4872f);
                    }
                    else if (trailerrandom == 2)
                    {
                        Meth.supply103vehicle1 = GTA.World.CreateVehicle(RequestModel(-2058878099), new GTA.Math.Vector3(1986.283f, 3033.763f, 49.30854f), 57.2417f);
                    }
                    else if (trailerrandom == 3)
                    {
                        Meth.supply103vehicle1 = GTA.World.CreateVehicle(RequestModel(-877478386), new GTA.Math.Vector3(2043.445f, 3179.405f, 46.97549f), 150.7142f);
                    }
                    else if (trailerrandom == 4)
                    {
                        Meth.supply103vehicle1 = GTA.World.CreateVehicle(RequestModel(-2058878099), new GTA.Math.Vector3(1964.73f, 3773.939f, 34.44862f), 30.64485f);
                    }
                    else if (trailerrandom == 5)
                    {
                        Meth.supply103vehicle1 = GTA.World.CreateVehicle(RequestModel(-877478386), new GTA.Math.Vector3(2531.43f, 4212.072f, 42.07367f), -119.55f);
                    }
                    else if (trailerrandom == 6)
                    {
                        Meth.supply103vehicle1 = GTA.World.CreateVehicle(RequestModel(-2058878099), new GTA.Math.Vector3(1026.152f, 2657.845f, 41.80072f), 0.6971049f);
                    }
                    else
                    {
                        Meth.supply103vehicle1 = GTA.World.CreateVehicle(RequestModel(-877478386), new GTA.Math.Vector3(2654.815f, 3269.256f, 57.22864f), 155.5547f);
                    }

                    supply103vehicle2 = GTA.World.CreateVehicle(RequestModel(1518533038), new GTA.Math.Vector3(1435.672f, 3614.65f, 35.1493f), -175.5079f);
                    supply103vehicle3 = GTA.World.CreateVehicle(RequestModel(-2137348917), new GTA.Math.Vector3(1347.635f, 3604.135f, 34.96044f), -161.5265f);
                ...
                if (Meth.Supplier == 104)
                {
                    ...
                    if (helirandom == 1)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(1732.262f, 3242.769f, 41.48026f), 75.67314f);
                    }
                    else if (helirandom == 2)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(1753.671f, 3287.452f, 41.21537f), -103.8992f);
                    }
                    else if (helirandom == 3)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2406.913f, 3105.336f, 48.27777f), 21.42589f);
                    }
                    else if (helirandom == 4)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2377.794f, 3073.108f, 48.25303f), 35.36357f);
                    }
                    else if (helirandom == 5)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2476f, 3421.79f, 50.01036f), 53.81745f);
                    }
                    else if (helirandom == 6)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2666.968f, 3521.062f, 52.75391f), -88.243f);
                    }
                    else if (helirandom == 7)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2353.328f, 3163.355f, 48.1737f), 142.9971f);
                    }
                    else if (helirandom == 8)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2167.511f, 3509.406f, 45.54001f), 35.77105f);
                    }
                    else if (helirandom == 9)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2138.194f, 4817.966f, 41.30239f), 61.83923f);
                    }
                    else if (helirandom == 10)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(2515.929f, 4971.677f, 44.66019f), 10.85086f);
                    }
                    else if (helirandom == 11)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(715.3496f, 4173.084f, 40.80654f), -115.5262f);
                    }
                    else if (helirandom == 12)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(354.1948f, 4446.923f, 62.96617f), -145.588f);
                    }
                    else if (helirandom == 13)
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(-1910.104f, 2051.097f, 140.8349f), -168.7388f);
                    }
                    else
                    {
                        Meth.supply104vehicle1 = GTA.World.CreateVehicle(RequestModel(-1660661558), new GTA.Math.Vector3(-2626.112f, 3445.36f, 15.40589f), 13.93891f);
                    }

                    //Crates
                    Vector3 rot = new GTA.Math.Vector3(1388.729f, 3613.192f, 42.63286f);
                    Model model = RequestModel(-230239317);
                    model.Request(10000);
                    ...
                    AttachEntityToEntity(supply104crate1, supply104vehicle1, supply104vehicle1.Bones["bodyshell"].Index, new Vector3(0f, 0.3f, 0.253f), new Vector3(0f, 0f, 0f), false, false, false, 2, true);
        ...
        public static void DoCustomer()
        {
            try
            {
                ...
                if (Meth.Customer == 1)
                {
                    Meth.deal1vehicle1 = World.CreateVehicle(RequestModel(1069929536), new Vector3(903.9921f, 3614.968f, 32.58949f), 158.9581f);
                    Meth.deal1ped1 = World.CreatePed(RequestModel(1001210244), new Vector3(905.2158f, 3614.332f, 32.81895f), -100.99f);
                    Meth.deal1ped2 = World.CreatePed(RequestModel(1768677545), new Vector3(905.5829f, 3614.969f, 32.81862f), -122.5152f);
                    Meth.deal1ped3 = World.CreatePed(RequestModel(-1806291497), new Vector3(894.18f, 3599.565f, 32.81421f), 136.3854f);
                    Meth.deal1ped4 = World.CreatePed(RequestModel(846439045), new Vector3(893.1466f, 3598.943f, 32.81421f), -75.9983f);
                    Meth.deal1ped2.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER", Meth.deal1ped2.Position.Z);
                    Meth.deal1ped3.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal1ped3.Position.Z);
                    Meth.deal1ped4.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER_HARD", Meth.deal1ped4.Position.Z);
                ...
                if (Meth.Customer == 2)
                {
                    Meth.deal2vehicle1 = World.CreateVehicle(RequestModel(-682211828), new Vector3(2362.594f, 3117.407f, 47.57828f), -27.40716f);
                    Meth.deal2ped1 = World.CreatePed(RequestModel(32417469), new Vector3(2363.88f, 3119.749f, 48.20966f), -54.30811f);
                    Meth.deal2ped2 = World.CreatePed(RequestModel(810804565), new Vector3(2363.894f, 3121.085f, 48.20894f), -123.3657f);
                    ...
                    Meth.deal2ped2.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER_HARD", Meth.deal2ped2.Position.Z);
                ...
                if (Meth.Customer == 3)
                {
                    Meth.deal3vehicle1 = World.CreateVehicle(RequestModel(-2045594037), new Vector3(2875.308f, 3688.122f, 48.22939f), -102.8129f);
                    Meth.deal3ped1 = World.CreatePed(RequestModel(-106498753), new Vector3(2878.413f, 3686.557f, 48.20292f), -50.73355f);
                    Meth.deal3ped2 = World.CreatePed(RequestModel(-578715987), new Vector3(2879.039f, 3686.151f, 48.17934f), -17.03479f);
                    ...
                    Meth.deal3ped2.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal3ped2.Position.Z);
                ...
                if (Meth.Customer == 4)
                {
                    Meth.deal4vehicle1 = World.CreateVehicle(RequestModel(-1311240698), new Vector3(1975.398f, 5168.382f, 47.4132f), 125.8284f);
                    Meth.deal4ped1 = World.CreatePed(RequestModel(-1806291497), new Vector3(1964.085f, 5172.845f, 47.80671f), 169.6814f);
                    Meth.deal4ped2 = World.CreatePed(RequestModel(-261389155), new Vector3(1970.798f, 5169.874f, 47.6391f), -46.46468f);
                    Meth.deal4ped3 = World.CreatePed(RequestModel(-1332260293), new Vector3(1964.81f, 5172.308f, 47.76441f), 146.9773f);
                    ...
                    Meth.deal4ped2.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal4ped2.Position.Z);
                    Meth.deal4ped3.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER_HARD", Meth.deal4ped3.Position.Z);
                ...
                if (Meth.Customer == 5)
                {
                    Meth.deal5vehicle1 = World.CreateVehicle(RequestModel(-1453280962), new Vector3(99.58822f, 6848.579f, 15.40964f), -28.20744f);
                    Meth.deal5ped1 = World.CreatePed(RequestModel(-1313761614), new Vector3(100.7299f, 6847.384f, 16.04326f), -50.46243f);
                ...
                if (Meth.Customer == 6)
                {
                    Meth.deal6ped1 = World.CreatePed(RequestModel(1787764635), new Vector3(119.4116f, -1198.594f, 29.29514f), 108.7571f);
                    Meth.deal6ped2 = World.CreatePed(RequestModel(1404403376), new Vector3(119.2179f, -1199.78f, 29.29514f), 61.99771f);
                    Meth.deal6ped2.Task.StartScenario("WORLD_HUMAN_SMOKING", Meth.deal6ped2.Position.Z);
                ...
                if (Meth.Customer == 7)
                {
                    Meth.deal7ped1 = World.CreatePed(RequestModel(835315305), new Vector3(-3193.423f, 1231.214f, 10.04833f), -72.65874f);
                ...
                if (Meth.Customer == 8)
                {
                    Meth.deal8vehicle1 = World.CreateVehicle(RequestModel(-1743316013), new Vector3(1208.471f, 2638.869f, 37.62344f), -69.56764f);
                    Meth.deal8ped1 = World.CreatePed(RequestModel(1768677545), new Vector3(1213.307f, 2643.646f, 37.80995f), 58.5533f);
                    Meth.deal8ped2 = World.CreatePed(RequestModel(348382215), new Vector3(1212.701f, 2643.277f, 37.80995f), 32.53157f);
                    Meth.deal8ped3 = World.CreatePed(RequestModel(-429715051), new Vector3(1206.976f, 2636.807f, 37.80995f), 160.6528f);
                    Meth.deal8ped1.Weapons.Give(WeaponHash.Pistol, 100, true, false);
                    Meth.deal8ped3.Weapons.Give(WeaponHash.SMG, 100, true, false);
                    Meth.deal8ped2.Task.StartScenario("WORLD_HUMAN_STAND_IMPATIENT", Meth.deal8ped2.Position.Z);
                    Meth.deal8ped3.Task.StartScenario("WORLD_HUMAN_GUARD_STAND", Meth.deal8ped3.Position.Z);
                ...
                {
                    Meth.deal8vehicle1 = World.CreateVehicle(RequestModel(-1743316013), new Vector3(1208.471f, 2638.869f, 37.62344f), -69.56764f);
                    Meth.deal9ped1 = World.CreatePed(RequestModel(653210662), new Vector3(1684.572f, 3288.351f, 41.14653f), 166.6336f);
                    Meth.deal9ped2 = World.CreatePed(RequestModel(-1561829034), new Vector3(1685.098f, 3287.572f, 41.14653f), 122.9997f);
                ...
                if (Meth.Customer == 10)
                {
                    Meth.deal10vehicle1 = World.CreateVehicle(RequestModel(-1323100960), new Vector3(2159.83f, 2117.29f, 126.2178f), 4.071282f);
                    Meth.deal10ped1 = World.CreatePed(RequestModel(-1105179493), new Vector3(2162.119f, 2117.68f, 125.9504f), -52.66581f);
                    Meth.deal10ped2 = World.CreatePed(RequestModel(-2039072303), new Vector3(2161.88f, 2118.494f, 125.9314f), -88.54652f);
                    Meth.deal10ped2.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER_HARD", Meth.deal10ped2.Position.Z);
                ...
                if (Meth.Customer == 11)
                {
                    Meth.deal11vehicle1 = World.CreateVehicle(RequestModel(-1297672541), new Vector3(2591.913f, 3160.892f, 50.05851f), -47.32346f);
                    Meth.deal11vehicle2 = World.CreateVehicle(RequestModel(2006918058), new Vector3(2576.226f, 3177.663f, 50.83627f), -71.95502f);
                    Meth.deal11vehicle3 = World.CreateVehicle(RequestModel(2006667053), new Vector3(2596.835f, 3183.224f, 51.48439f), 91.72227f);
                    Meth.deal11vehicle4 = World.CreateVehicle(RequestModel(1770332643), new Vector3(2597.577f, 3161.19f, 50.58514f), 22.94889f);
                    Meth.deal11vehicle5 = World.CreateVehicle(RequestModel(1739845664), new Vector3(2601.628f, 3177.119f, 51.17874f), -146.8833f);
                    Meth.deal11vehicle6 = World.CreateVehicle(RequestModel(1177543287), new Vector3(2586.546f, 3173.46f, 50.66679f), -158.6337f);
                    Meth.deal11vehicle7 = World.CreateVehicle(RequestModel(1126868326), new Vector3(2593.368f, 3167.821f, 50.62262f), 95.59938f);
                    Meth.deal11ped1 = World.CreatePed(RequestModel(51789996), new Vector3(2594.258f, 3170.011f, 51.03237f), 5.594477f);
                    Meth.deal11ped2 = World.CreatePed(RequestModel(-9308122), new Vector3(2593.87f, 3170.533f, 51.03777f), -22.03105f);
                    Meth.deal11ped3 = World.CreatePed(RequestModel(-48477765), new Vector3(2578.827f, 3178.599f, 51.2319f), -47.13006f);
                    Meth.deal11ped4 = World.CreatePed(RequestModel(-96953009), new Vector3(2580.009f, 3154.376f, 50.63525f), -158.4494f);
                    Meth.deal11ped5 = World.CreatePed(RequestModel(-198252413), new Vector3(2580.321f, 3153.514f, 50.60846f), 22.99918f);
                    Meth.deal11ped6 = World.CreatePed(RequestModel(-1492432238), new Vector3(2592.883f, 3160.074f, 50.82481f), -121.5816f);
                    Meth.deal11ped7 = World.CreatePed(RequestModel(-1561829034), new Vector3(2593.797f, 3159.549f, 50.82723f), 68.9992f);
                    Meth.deal11ped2.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal11ped2.Position.Z);
                    Meth.deal11ped3.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER", Meth.deal11ped3.Position.Z);
                    Meth.deal11ped4.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER", Meth.deal11ped4.Position.Z);
                    Meth.deal11ped5.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal11ped5.Position.Z);
                    Meth.deal11ped6.Task.StartScenario("WORLD_HUMAN_SMOKING", Meth.deal11ped6.Position.Z);
                    Meth.deal11ped7.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal11ped7.Position.Z);
                ...
                if (Meth.Customer == 12)
                {
                    Meth.deal12vehicle1 = World.CreateVehicle(RequestModel(296357396), new Vector3(-387.5374f, 3960.952f, 58.28973f), -71.94999f);
                    Meth.deal12vehicle2 = World.CreateVehicle(RequestModel(296357396), new Vector3(-387.1665f, 3972.754f, 55.57044f), -62.34592f);
                    Meth.deal12ped1 = World.CreatePed(RequestModel(850468060), new Vector3(-382.9714f, 3964.177f, 57.44019f), 23.00121f);
                    Meth.deal12ped2 = World.CreatePed(RequestModel(1032073858), new Vector3(-384.0755f, 3964.24f, 57.44724f), -14.99981f);
                    Meth.deal12ped3 = World.CreatePed(RequestModel(-44746786), new Vector3(-374.0284f, 3968.86f, 58.13343f), 79.39861f);
                    Meth.deal12ped4 = World.CreatePed(RequestModel(1330042375), new Vector3(-386.821f, 3971.079f, 55.85037f), -176.5453f);
                    Meth.deal12ped5 = World.CreatePed(RequestModel(1001210244), new Vector3(-390.5976f, 3960.009f, 58.91197f), 99.01192f);
                    Meth.deal12ped6 = World.CreatePed(RequestModel(1064866854), new Vector3(-386.3978f, 3970.292f, 55.9568f), 40.54969f);
                    Meth.deal12ped2.Task.StartScenario("WORLD_HUMAN_GUARD_STAND_ARMY", Meth.deal12ped2.Position.Z);
                    Meth.deal12ped3.Task.StartScenario("WORLD_HUMAN_SMOKING", Meth.deal12ped3.Position.Z);
                    Meth.deal12ped4.Task.StartScenario("WORLD_HUMAN_SMOKING", Meth.deal12ped4.Position.Z);
                    Meth.deal12ped5.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal12ped5.Position.Z);
                    Meth.deal12ped6.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER_HARD", Meth.deal12ped6.Position.Z);
                ...
                if (Meth.Customer == 13)
                {
                    Meth.deal13vehicle1 = World.CreateVehicle(RequestModel(-1150599089), new Vector3(1645.381f, 4840.075f, 41.55758f), 173.8161f);
                    Meth.deal13ped1 = World.CreatePed(RequestModel(1822107721), new Vector3(1642.083f, 4835.897f, 42.02521f), 174.9498f);
                    Meth.deal13ped2 = World.CreatePed(RequestModel(-1709285806), new Vector3(1641.204f, 4835.851f, 42.02419f), -161.9165f);
                    Meth.deal13ped2.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal13ped2.Position.Z);
                ...
                if (Meth.Customer == 14)
                {
                    Meth.deal14vehicle1 = World.CreateVehicle(RequestModel(683047626), new Vector3(1308.926f, 4325.389f, 38.38759f), 46.92113f);
                    Meth.deal14ped1 = World.CreatePed(RequestModel(-236444766), new Vector3(1311.5f, 4326.893f, 38.11893f), -54.99969f);
                    Meth.deal14ped2 = World.CreatePed(RequestModel(-412008429), new Vector3(1308.6f, 4328.411f, 38.21348f), -95.97929f);
                    Meth.deal14ped3 = World.CreatePed(RequestModel(-39239064), new Vector3(1311.4f, 4326.204f, 38.1059f), -49.02412f);
                    Meth.deal14ped4 = World.CreatePed(RequestModel(-984709238), new Vector3(1308.644f, 4322.238f, 38.13105f), 166.0579f);
                    Meth.deal14ped2.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal14ped2.Position.Z);
                    Meth.deal14ped3.Task.StartScenario("WORLD_HUMAN_SMOKING", Meth.deal14ped3.Position.Z);
                    Meth.deal14ped4.Task.StartScenario("WORLD_HUMAN_SMOKING_POT", Meth.deal14ped4.Position.Z);
                ...
                if (Meth.Customer == 15)
                {
                    Meth.deal15ped1 = World.CreatePed(RequestModel(2064532783), new Vector3(726.8161f, 4169.482f, 40.70921f), 2.627836f);
        ...
        public static void DoUpgrade(int upgradeNum)
        {
            ...
            try
            {
                ...
                if (Meth.UpgradeMission == 1)
                {
                    ...
                    TextNotification("CHAR_RON", "~b~Ron", "Text message", msg2do);
                    upgrade1_part = 1;
                    Meth.upgrade1vehicle1 = GTA.World.CreateVehicle(RequestModel(-1189015600), new GTA.Math.Vector3(1527.49f, 1719.386f, 109.9832f), -173.6879f); //Main truck
                    Meth.upgrade1vehicle2 = GTA.World.CreateVehicle(RequestModel(142944341), new GTA.Math.Vector3(1521.321f, 1711.991f, 109.9413f), -24.00047f);
                    Meth.upgrade1vehicle3 = GTA.World.CreateVehicle(RequestModel(683047626), new GTA.Math.Vector3(1516.051f, 1736.756f, 110.3977f), -113.6923f);
                    Meth.upgrade1vehicle4 = GTA.World.CreateVehicle(RequestModel(-394074634), new GTA.Math.Vector3(1515.614f, 1723.972f, 109.8184f), 54.88525f);
                    Meth.upgrade1vehicle5 = GTA.World.CreateVehicle(RequestModel(410882957), new GTA.Math.Vector3(1530.568f, 1732.291f, 109.8262f), 127.2168f);
                    Meth.upgrade1vehicle6 = GTA.World.CreateVehicle(RequestModel(989381445), new GTA.Math.Vector3(1533.172f, 1714.981f, 109.7356f), -165.194f);

                    Meth.upgrade1vehicle7 = GTA.World.CreateVehicle(RequestModel(-394074634), new GTA.Math.Vector3(1404.661f, 2164.737f, 97.77354f), -39.50379f); //Scene 1
                    Meth.upgrade1vehicle8 = GTA.World.CreateVehicle(RequestModel(-394074634), new GTA.Math.Vector3(1418.099f, 2166.874f, 96.94195f), 25.47694f); //Scene 1
                    Meth.upgrade1vehicle9 = GTA.World.CreateVehicle(RequestModel(-394074634), new GTA.Math.Vector3(1575.517f, 2199.876f, 78.68687f), 62.37475f); //Scene 2

                    Meth.upgrade1ped15 = GTA.World.CreatePed(RequestModel(-1561829034), new GTA.Math.Vector3(1401.531f, 2169.873f, 97.76701f), -92.41866f);
                    Meth.upgrade1ped16 = GTA.World.CreatePed(RequestModel(846439045), new GTA.Math.Vector3(1416.256f, 2170.812f, 97.04028f), -113.6568f);
                    Meth.upgrade1ped17 = GTA.World.CreatePed(RequestModel(1746653202), new GTA.Math.Vector3(1417.548f, 2170.411f, 97.003f), 72.64591f);
                    Meth.upgrade1ped18 = GTA.World.CreatePed(RequestModel(1746653202), new GTA.Math.Vector3(1574.325f, 2197.909f, 79.1595f), 101.3092f);


                    Vector3 rot = new GTA.Math.Vector3(0f, 0f, 0f);
                    Model model = RequestModel(-1935686084);
                    model.Request(10000);
                    ...
                    AttachEntityToEntity(upgrade1barrel1, upgrade1vehicle1, upgrade1vehicle1.Bones["bodyshell"].Index, new Vector3(-0.28f, -1.73f, 0.83f), new Vector3(0f, 0f, 130f), false, false, false, 2, true);
                    model.Request(10000);
                    ...
                    AttachEntityToEntity(upgrade1barrel2, upgrade1vehicle1, upgrade1vehicle1.Bones["bodyshell"].Index, new Vector3(0.35f, -2.43f, 0.83f), new Vector3(0f, 0f, 70f), false, false, false, 2, true);
                    model.Request(10000);
                    ...
                    AttachEntityToEntity(upgrade1barrel3, upgrade1vehicle1, upgrade1vehicle1.Bones["bodyshell"].Index, new Vector3(-0.38f, -2.83f, 0.83f), new Vector3(0f, 0f, 0f), false, false, false, 2, true);
                    Meth.upgrade1ped1 = GTA.World.CreatePed(RequestModel(-236444766), new GTA.Math.Vector3(1523.41f, 1716.995f, 109.9647f), 15.15256f);
                    Meth.upgrade1ped2 = GTA.World.CreatePed(RequestModel(-39239064), new GTA.Math.Vector3(1531.398f, 1729.404f, 109.9239f), 96.99794f);
                    Meth.upgrade1ped3 = GTA.World.CreatePed(RequestModel(653289389), new GTA.Math.Vector3(1523.59f, 1718.072f, 109.938f), 171.9949f);
                    Meth.upgrade1ped4 = GTA.World.CreatePed(RequestModel(-306416314), new GTA.Math.Vector3(1522.69f, 1717.877f, 110.0101f), -139.9321f);
                    Meth.upgrade1ped5 = GTA.World.CreatePed(RequestModel(-9308122), new GTA.Math.Vector3(1530.97f, 1723.696f, 110.1303f), 84.34628f);
                    Meth.upgrade1ped6 = GTA.World.CreatePed(RequestModel(663522487), new GTA.Math.Vector3(1516.373f, 1735.015f, 110.2355f), 145.3333f);
                    Meth.upgrade1ped7 = GTA.World.CreatePed(RequestModel(846439045), new GTA.Math.Vector3(1515.398f, 1735.341f, 110.2111f), 179.0022f);
                    Meth.upgrade1ped8 = GTA.World.CreatePed(RequestModel(-48477765), new GTA.Math.Vector3(1519.536f, 1712.766f, 110.2065f), 51.99932f);
                    Meth.upgrade1ped9 = GTA.World.CreatePed(RequestModel(-1395868234), new GTA.Math.Vector3(1525.239f, 1720.919f, 109.9964f), 86.99884f);
                    Meth.upgrade1ped10 = GTA.World.CreatePed(RequestModel(691061163), new GTA.Math.Vector3(1519.113f, 1722.291f, 110.2926f), -45.16341f);
                    Meth.upgrade1ped11 = GTA.World.CreatePed(RequestModel(-1872961334), new GTA.Math.Vector3(1539.237f, 1703.978f, 109.6578f), 107.9994f);
                    Meth.upgrade1ped12 = GTA.World.CreatePed(RequestModel(62440720), new GTA.Math.Vector3(1538.304f, 1702.64f, 109.6635f), -38.99947f);
                    Meth.upgrade1ped13 = GTA.World.CreatePed(RequestModel(663522487), new GTA.Math.Vector3(1537.909f, 1704.345f, 109.6678f), -92.53496f);
                    Meth.upgrade1ped14 = GTA.World.CreatePed(RequestModel(1768677545), new GTA.Math.Vector3(1538.656f, 1727.263f, 109.8323f), -74.26968f);
                    Meth.upgrade1ped2.Task.StartScenario("WORLD_HUMAN_DRUG_DEALER", Meth.upgrade1ped2.Position.Z);
                ...
                if (Meth.UpgradeMission == 2)
                {
                    ...
                    Meth.upgrade2vehicle1 = GTA.World.CreateVehicle(RequestModel(-877478386), new GTA.Math.Vector3(246.4641f, 3152.454f, 44.47647f), 89.94525f);
                    Meth.upgrade2vehicle2 = GTA.World.CreateVehicle(RequestModel(-877478386), new GTA.Math.Vector3(261.8186f, 3113.418f, 44.52674f), -178.7754f);
                    Meth.upgrade2vehicle3 = GTA.World.CreateVehicle(RequestModel(-2140431165), new GTA.Math.Vector3(264.2597f, 3166.078f, 42.12355f), -23.28482f);
                    Meth.upgrade2vehicle4 = GTA.World.CreateVehicle(RequestModel(-2128233223), new GTA.Math.Vector3(263.6903f, 3169.688f, 42.09707f), -107.68f);
                    Meth.upgrade2vehicle5 = GTA.World.CreateVehicle(RequestModel(-1207771834), new GTA.Math.Vector3(246.8931f, 3144.242f, 41.88817f), 119.2207f);
                    Meth.upgrade2vehicle6 = GTA.World.CreateVehicle(RequestModel(-1453280962), new GTA.Math.Vector3(242.7702f, 3166.022f, 42.23487f), 136.6276f);
                    Meth.upgrade2vehicle7 = GTA.World.CreateVehicle(RequestModel(741090084), new GTA.Math.Vector3(233.4951f, 3160.77f, 41.89718f), 51.7664f);
                    Meth.upgrade2vehicle8 = GTA.World.CreateVehicle(RequestModel(833469436), new GTA.Math.Vector3(344.7992f, 3465.745f, 35.32477f), -128.7532f); //Gang event 1
                    Meth.upgrade2vehicle9 = GTA.World.CreateVehicle(RequestModel(-1745203402), new GTA.Math.Vector3(227.2207f, 2882.327f, 43.3088f), -109.0894f); //Gang event 2
                    Meth.upgrade2vehicle10 = GTA.World.CreateVehicle(RequestModel(1069929536), new GTA.Math.Vector3(242.081f, 3183.807f, 42.79674f), 123.6404f);

                    Meth.upgrade2ped1 = GTA.World.CreatePed(RequestModel(1032073858), new GTA.Math.Vector3(243.1876f, 3168.701f, 42.8461f), -106.2888f);
                    Meth.upgrade2ped2 = GTA.World.CreatePed(RequestModel(850468060), new GTA.Math.Vector3(244.3157f, 3168.106f, 42.82878f), 64.99089f);
                    Meth.upgrade2ped3 = GTA.World.CreatePed(RequestModel(1330042375), new GTA.Math.Vector3(263.1049f, 3172.014f, 42.61808f), -43.10589f);
                    Meth.upgrade2ped4 = GTA.World.CreatePed(RequestModel(-44746786), new GTA.Math.Vector3(263.803f, 3172.665f, 42.5453f), 136.7907f);
                    Meth.upgrade2ped5 = GTA.World.CreatePed(RequestModel(1626646295), new GTA.Math.Vector3(243.4767f, 3140.667f, 42.48498f), 9.081732f);
                    Meth.upgrade2ped6 = GTA.World.CreatePed(RequestModel(-1773858377), new GTA.Math.Vector3(244.1639f, 3141.838f, 42.45826f), 141.9988f);
                    Meth.upgrade2ped7 = GTA.World.CreatePed(RequestModel(-1299428795), new GTA.Math.Vector3(242.7615f, 3141.828f, 42.44957f), -115.9992f);
                    Meth.upgrade2ped8 = GTA.World.CreatePed(RequestModel(850468060), new GTA.Math.Vector3(343.7276f, 3462.584f, 35.74516f), -16.00084f); //Gang event 1
                    Meth.upgrade2ped9 = GTA.World.CreatePed(RequestModel(1032073858), new GTA.Math.Vector3(343.617f, 3463.599f, 35.75167f), 149.1334f); //Gang event 1
                    Meth.upgrade2ped10 = GTA.World.CreatePed(RequestModel(1330042375), new GTA.Math.Vector3(342.5839f, 3463.254f, 35.76863f), -61.99973f); //Gang event 1
                    Meth.upgrade2ped11 = GTA.World.CreatePed(RequestModel(-984709238), new GTA.Math.Vector3(227.8388f, 2884.177f, 43.46758f), -46.99897f); //Gang event 2
                    Meth.upgrade2ped12 = GTA.World.CreatePed(RequestModel(-39239064), new GTA.Math.Vector3(229.1046f, 2883.65f, 43.49247f), 3.259262f); //Gang event 2
                ...
                if (Meth.UpgradeMission == 3)
                {
                    ...
                    Meth.upgrade3vehicle1 = GTA.World.CreateVehicle(RequestModel(-1590337689), new GTA.Math.Vector3(1359.492f, 4367.401f, 43.8379f), 156.484f); //Blazer aqua
                    Meth.upgrade3vehicle2 = GTA.World.CreateVehicle(RequestModel(-1590337689), new GTA.Math.Vector3(1353.455f, 4366.292f, 43.84185f), 22.96266f); //Blazer false
                    Meth.upgrade3vehicle3 = GTA.World.CreateVehicle(RequestModel(-1590337689), new GTA.Math.Vector3(1357.915f, 4375.192f, 43.86413f), -141.0174f); //Blazer false
                    Meth.upgrade3vehicle4 = GTA.World.CreateVehicle(RequestModel(-808831384), new GTA.Math.Vector3(1385.765f, 4378.497f, 43.46906f), 134.3735f); //Baller
                    Meth.upgrade3vehicle5 = GTA.World.CreateVehicle(RequestModel(-2030171296), new GTA.Math.Vector3(1376.564f, 4363.88f, 43.38467f), 37.44493f); //Cognoscenti
                    Meth.upgrade3vehicle6 = GTA.World.CreateVehicle(RequestModel(-1237253773), new GTA.Math.Vector3(1364.246f, 4379.04f, 44.20669f), -30.88138f); //Dubsta 6 wheeler
                    Meth.upgrade3vehicle7 = GTA.World.CreateVehicle(RequestModel(-1661854193), new GTA.Math.Vector3(1343.403f, 4366.336f, 43.79815f), -70.81923f); //Dune buggy
                    Meth.upgrade3vehicle8 = GTA.World.CreateVehicle(RequestModel(276773164), new GTA.Math.Vector3(1338.533f, 4280.577f, 30.70993f), -159.6408f); //Boat
                    upgrade3vehicle8.IsPositionFrozen = true;

                    Vector3 rot = new GTA.Math.Vector3(0f, 0f, 0f);
                    Model model = RequestModel(1877891248);
                    model.Request(10000);
                    ...
                    AttachEntityToEntity(upgrade3crate1, upgrade3vehicle1, upgrade3vehicle1.Bones["bodyshell"].Index, new Vector3(0.01f, -0.76f, 0.69f), new Vector3(0f, 0f, 90f), false, false, false, 2, true);

                    Meth.upgrade3ped1 = GTA.World.CreatePed(RequestModel(-1109568186), new GTA.Math.Vector3(1369.592f, 4366.989f, 44.35347f), 66.99814f); //Mex
                    Meth.upgrade3ped2 = GTA.World.CreatePed(RequestModel(1466037421), new GTA.Math.Vector3(1368.883f, 4367.682f, 44.35664f), 84.2487f); //Mex boss
                    Meth.upgrade3ped3 = GTA.World.CreatePed(RequestModel(653210662), new GTA.Math.Vector3(1372.955f, 4362.504f, 44.28195f), -35.98015f); //Mex
                    Meth.upgrade3ped4 = GTA.World.CreatePed(RequestModel(832784782), new GTA.Math.Vector3(1369.76f, 4368.032f, 44.36926f), 103.9989f); //Mex
                    Meth.upgrade3ped5 = GTA.World.CreatePed(RequestModel(-1773333796), new GTA.Math.Vector3(1372.061f, 4380.071f, 44.44684f), 173.601f); //Mex
                    Meth.upgrade3ped6 = GTA.World.CreatePed(RequestModel(-1872961334), new GTA.Math.Vector3(1367.414f, 4367.726f, 44.34414f), -86.99913f); //Gang boss
                    Meth.upgrade3ped7 = GTA.World.CreatePed(RequestModel(846439045), new GTA.Math.Vector3(1366.828f, 4368.63f, 44.38201f), -94.99944f); //Gang
                    Meth.upgrade3ped8 = GTA.World.CreatePed(RequestModel(663522487), new GTA.Math.Vector3(1366.573f, 4366.807f, 44.34046f), -65.99858f); //Gang
                    Meth.upgrade3ped9 = GTA.World.CreatePed(RequestModel(62440720), new GTA.Math.Vector3(1365.113f, 4376.362f, 44.33229f), -150.0214f); //Gang
                    Meth.upgrade3ped10 = GTA.World.CreatePed(RequestModel(1657546978), new GTA.Math.Vector3(1352.012f, 4378.236f, 44.34339f), 158.5874f); //Marine mech
                    Meth.upgrade3ped11 = GTA.World.CreatePed(RequestModel(-1806291497), new GTA.Math.Vector3(1334.617f, 4281.201f, 31.95599f), -2.965704f); //Boat farmer
                    Meth.upgrade3ped12 = GTA.World.CreatePed(RequestModel(832784782), new GTA.Math.Vector3(1334.108f, 4282.262f, 31.96284f), -110.9856f); //Boat Mex1
                    Meth.upgrade3ped13 = GTA.World.CreatePed(RequestModel(1226102803), new GTA.Math.Vector3(1335.069f, 4282.869f, 31.97103f), 169.6599f); //Boat Mex2
                ...
                if (Meth.UpgradeMission == 4)
                {
                    ...
                    Meth.upgrade4vehicle1 = GTA.World.CreateVehicle(RequestModel(-1045541610), new GTA.Math.Vector3(591.3066f, 2789.264f, 41.75668f), -68.0082f);
                    Meth.upgrade4vehicle2 = GTA.World.CreateVehicle(RequestModel(634118882), new GTA.Math.Vector3(572.5638f, 2811.909f, 41.92053f), -59.77626f);
                    Meth.upgrade4vehicle3 = GTA.World.CreateVehicle(RequestModel(470404958), new GTA.Math.Vector3(584.0295f, 2787.847f, 42.10477f), 60.98061f);
                    Meth.upgrade4vehicle4 = GTA.World.CreateVehicle(RequestModel(-1041692462), new GTA.Math.Vector3(644.8695f, 2803.136f, 41.4424f), 29.24689f);
                    Meth.upgrade4vehicle5 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(613.2159f, 2794.607f, 42.3051f), 12.7858f);
                    Meth.upgrade4vehicle6 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(605.49f, 2794.889f, 42.28812f), 9.250314f);
                    Meth.upgrade4vehicle7 = GTA.World.CreateVehicle(RequestModel(729783779), new GTA.Math.Vector3(567.3011f, 2805.429f, 41.68729f), -136.3322f);
                    Meth.upgrade4vehicle8 = GTA.World.CreateVehicle(RequestModel(833469436), new GTA.Math.Vector3(617.7423f, 2806.427f, 41.56831f), 145.1322f);
                    Meth.upgrade4vehicle9 = GTA.World.CreateVehicle(RequestModel(-1207771834), new GTA.Math.Vector3(600.2106f, 2814.089f, 41.5104f), 67.33185f);
                    Meth.upgrade4vehicle10 = GTA.World.CreateVehicle(RequestModel(-1237253773), new GTA.Math.Vector3(624.9666f, 2815.154f, 41.74499f), 114.5348f);
                    Meth.upgrade4vehicle11 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(585.954f, 2812.867f, 42.04877f), -83.46241f);
                    Meth.upgrade4vehicle12 = GTA.World.CreateVehicle(RequestModel(1491375716), new GTA.Math.Vector3(577.6957f, 2797.949f, 41.58521f), 167.7358f);
                    Meth.upgrade4vehicle13 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(640.2717f, 2815.263f, 42.17973f), 80.77163f);


                    Meth.upgrade4ped1 = GTA.World.CreatePed(RequestModel(915948376), new GTA.Math.Vector3(569.9863f, 2798.275f, 42.0151f), -78.99911f); //Target - Stretch
                    Meth.upgrade4ped2 = GTA.World.CreatePed(RequestModel(846439045), new GTA.Math.Vector3(626.0748f, 2813.818f, 41.92717f), -127.9942f);
                    Meth.upgrade4ped3 = GTA.World.CreatePed(RequestModel(62440720), new GTA.Math.Vector3(568.9796f, 2800.857f, 42.01758f), -113.8988f);
                    Meth.upgrade4ped4 = GTA.World.CreatePed(RequestModel(663522487), new GTA.Math.Vector3(585.6151f, 2789.813f, 42.19036f), -8.761761f);
                    Meth.upgrade4ped5 = GTA.World.CreatePed(RequestModel(-1872961334), new GTA.Math.Vector3(590.4219f, 2790.818f, 42.17429f), 31.99987f);
                    Meth.upgrade4ped6 = GTA.World.CreatePed(RequestModel(891945583), new GTA.Math.Vector3(571.7787f, 2797.711f, 42.01931f), 77.34808f);
                    Meth.upgrade4ped7 = GTA.World.CreatePed(RequestModel(2093736314), new GTA.Math.Vector3(571.2259f, 2799.434f, 42.00717f), 133.3489f);
                    Meth.upgrade4ped8 = GTA.World.CreatePed(RequestModel(-1880237687), new GTA.Math.Vector3(599.434f, 2812.423f, 41.94796f), -176.1076f);
                    Meth.upgrade4ped9 = GTA.World.CreatePed(RequestModel(611648169), new GTA.Math.Vector3(599.3298f, 2811.287f, 41.96135f), -40.99991f);
                    Meth.upgrade4ped10 = GTA.World.CreatePed(RequestModel(611648169), new GTA.Math.Vector3(589.8497f, 2791.869f, 42.14715f), -152.9985f);
                    Meth.upgrade4ped11 = GTA.World.CreatePed(RequestModel(-1880237687), new GTA.Math.Vector3(585.5786f, 2790.99f, 42.16109f), 178.0007f);
                    Meth.upgrade4ped12 = GTA.World.CreatePed(RequestModel(653210662), new GTA.Math.Vector3(570.9409f, 2796.993f, 42.01257f), 22.43985f);
                    Meth.upgrade4ped13 = GTA.World.CreatePed(RequestModel(663522487), new GTA.Math.Vector3(600.4405f, 2811.51f, 41.95945f), 72.64059f);
                    Meth.upgrade4ped14 = GTA.World.CreatePed(RequestModel(1329576454), new GTA.Math.Vector3(598.9904f, 2784.715f, 43.48364f), 24.69019f);
                    Meth.upgrade4ped15 = GTA.World.CreatePed(RequestModel(-1561829034), new GTA.Math.Vector3(574.7351f, 2810.993f, 41.98013f), -114.1324f);
                    Meth.upgrade4ped16 = GTA.World.CreatePed(RequestModel(653210662), new GTA.Math.Vector3(627.3273f, 2813.238f, 41.98621f), 78.12077f);
                    Meth.upgrade4ped17 = GTA.World.CreatePed(RequestModel(810804565), new GTA.Math.Vector3(626.1317f, 2812.529f, 41.98296f), 8.000053f);
                    Meth.upgrade4ped18 = GTA.World.CreatePed(RequestModel(832784782), new GTA.Math.Vector3(616.8279f, 2807.398f, 41.93616f), 51.22027f);
                    Meth.upgrade4ped19 = GTA.World.CreatePed(RequestModel(1226102803), new GTA.Math.Vector3(615.6328f, 2813.778f, 41.94604f), -72.62566f);
                    Meth.upgrade4ped20 = GTA.World.CreatePed(RequestModel(1466037421), new GTA.Math.Vector3(615.8603f, 2814.927f, 41.9325f), -128.9988f);
                    Meth.upgrade4ped21 = GTA.World.CreatePed(RequestModel(-1773333796), new GTA.Math.Vector3(616.8854f, 2814.808f, 41.93087f), 146.9942f);
                    Meth.upgrade4ped22 = GTA.World.CreatePed(RequestModel(-1109568186), new GTA.Math.Vector3(616.9938f, 2813.509f, 41.94658f), 50.99944f);
                    Meth.upgrade4ped23 = GTA.World.CreatePed(RequestModel(32417469), new GTA.Math.Vector3(567.2343f, 2796.939f, 47.1707f), -75.99897f);
                    Meth.upgrade4ped24 = GTA.World.CreatePed(RequestModel(-1463670378), new GTA.Math.Vector3(642.1859f, 2806.918f, 41.89315f), -82.93587f);
                    Meth.upgrade4ped25 = GTA.World.CreatePed(RequestModel(-9308122), new GTA.Math.Vector3(643.4444f, 2806.316f, 41.86181f), 54.99777f);
                ...
                if (Meth.UpgradeMission == 5)
                {
                    ...
                    Meth.upgrade5vehicle1 = GTA.World.CreateVehicle(RequestModel(683047626), new GTA.Math.Vector3(1598.661f, 3608.97f, 35.37614f), -155.058f);
                    Meth.upgrade5vehicle2 = GTA.World.CreateVehicle(RequestModel(833469436), new GTA.Math.Vector3(1615.82f, 3598.637f, 34.77635f), 45.21072f);
                    Meth.upgrade5vehicle3 = GTA.World.CreateVehicle(RequestModel(296357396), new GTA.Math.Vector3(1575.516f, 3587.841f, 35.18399f), 106.9959f);
                    Meth.upgrade5vehicle4 = GTA.World.CreateVehicle(RequestModel(301427732), new GTA.Math.Vector3(1599.901f, 3596.937f, 34.89944f), -5.287963f);

                    Vector3 rot = new GTA.Math.Vector3(0f, 0f, 0f);
                    Model model = RequestModel(1370563384);
                    model.Request(10000);
                    ...
                    Meth.upgrade5ped1 = GTA.World.CreatePed(RequestModel(62440720), new GTA.Math.Vector3(1598.11f, 3586.552f, 38.76704f), 88.57852f);
                    Meth.upgrade5ped2 = GTA.World.CreatePed(RequestModel(-1872961334), new GTA.Math.Vector3(1592.519f, 3587.028f, 38.76751f), -111.154f);
                    Meth.upgrade5ped3 = GTA.World.CreatePed(RequestModel(-681546704), new GTA.Math.Vector3(1593.751f, 3587.881f, 38.7688f), -162.3806f);
                    Meth.upgrade5ped4 = GTA.World.CreatePed(RequestModel(663522487), new GTA.Math.Vector3(1593.65f, 3586.41f, 38.76919f), 51.99967f);
                    Meth.upgrade5ped5 = GTA.World.CreatePed(RequestModel(832784782), new GTA.Math.Vector3(1616.05f, 3567.361f, 38.78409f), 21.99969f);
                    Meth.upgrade5ped6 = GTA.World.CreatePed(RequestModel(846439045), new GTA.Math.Vector3(1603.82f, 3560.071f, 38.73138f), 69.99876f);
                    Meth.upgrade5ped7 = GTA.World.CreatePed(RequestModel(1329576454), new GTA.Math.Vector3(1594.071f, 3577.838f, 38.75615f), 128.018f);
                    Meth.upgrade5ped8 = GTA.World.CreatePed(RequestModel(2119136831), new GTA.Math.Vector3(1586.712f, 3594.283f, 38.73155f), 128.8141f);
                    Meth.upgrade5ped9 = GTA.World.CreatePed(RequestModel(-1773333796), new GTA.Math.Vector3(1579.896f, 3621.219f, 38.73136f), -32.01563f);
                    Meth.upgrade5ped10 = GTA.World.CreatePed(RequestModel(-1561829034), new GTA.Math.Vector3(1577.894f, 3605.896f, 38.78328f), 138.095f);
                    Meth.upgrade5ped11 = GTA.World.CreatePed(RequestModel(-984709238), new GTA.Math.Vector3(1593.43f, 3593.918f, 38.769f), 167.6748f);
                    Meth.upgrade5ped12 = GTA.World.CreatePed(RequestModel(-39239064), new GTA.Math.Vector3(1593.209f, 3592.634f, 38.76881f), -4.999965f);
                    Meth.upgrade5ped13 = GTA.World.CreatePed(RequestModel(62440720), new GTA.Math.Vector3(1569.699f, 3598.261f, 38.73359f), -85.33544f);
                ...
                if (Meth.UpgradeMission == 6)
                {
                    ...
                    Meth.upgrade6vehicle1 = GTA.World.CreateVehicle(RequestModel(970385471), new GTA.Math.Vector3(1713.198f, 3245.559f, 41.60305f), 72.62683f); //Hydra
                ...
                if (Meth.UpgradeMission == 7)
                {
                    ...
                    Meth.upgrade7vehicle1 = GTA.World.CreateVehicle(RequestModel(121658888), new GTA.Math.Vector3(1720.331f, 3771.685f, 34.19107f), -60.82315f); //Main boxville
                    Meth.upgrade7vehicle2 = GTA.World.CreateVehicle(RequestModel(1922255844), new GTA.Math.Vector3(1718.024f, 3760.726f, 33.71086f), 27.14984f);
                    Meth.upgrade7vehicle3 = GTA.World.CreateVehicle(RequestModel(1922255844), new GTA.Math.Vector3(1716.373f, 3783.111f, 34.19432f), -99.78946f);
                    Meth.upgrade7vehicle4 = GTA.World.CreateVehicle(RequestModel(788747387), new GTA.Math.Vector3(1733.465f, 3725.261f, 33.88317f), -19.82791f); //Heli

                    Meth.upgrade7ped1 = GTA.World.CreatePed(RequestModel(1631478380), new GTA.Math.Vector3(1720.118f, 3774.807f, 34.36997f), -48.46706f);
                    Meth.upgrade7ped2 = GTA.World.CreatePed(RequestModel(-166363761), new GTA.Math.Vector3(1720.743f, 3775.624f, 34.38486f), 175.9996f);
                    Meth.upgrade7ped3 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1714.772f, 3781.083f, 34.60204f), -118.154f); //Car 2
                    Meth.upgrade7ped5 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1716.026f, 3780.612f, 34.57866f), 86.00036f); //Car 1
                    Meth.upgrade7ped4 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1716.631f, 3759.527f, 34.14696f), 69.98949f); //Car 2
                    Meth.upgrade7ped6 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1715.553f, 3760.313f, 34.16565f), -133.9966f); //Car1 
                    Meth.upgrade7ped7 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1737.369f, 3726.708f, 33.9486f), -98.17947f); //Heli
                    Meth.upgrade7ped8 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1738.994f, 3727.743f, 33.93015f), -169.9842f); //Heli
                    Meth.upgrade7ped9 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1738.587f, 3725.284f, 33.96076f), 13.99961f); //Heli
                    Meth.upgrade7ped10 = GTA.World.CreatePed(RequestModel(788443093), new GTA.Math.Vector3(1739.952f, 3725.922f, 33.9471f), 55.04275f); //Heli
                ...
                if (Meth.UpgradeMission == 8)
                {
                    ...
                    Meth.upgrade8vehicle1 = GTA.World.CreateVehicle(RequestModel(744705981), new GTA.Math.Vector3(1718.7769f, 3243.0417f, 41.84519f), 104.8894f); //Frogger
                ...
                if (Meth.UpgradeMission == 10)
                {
                    ...
                    Meth.upgrade10vehicle1 = GTA.World.CreateVehicle(RequestModel(296357396), new GTA.Math.Vector3(1758.02f, 3345.653f, 40.83251f), 161.4725f);
                    Meth.upgrade10ped1 = GTA.World.CreatePed(RequestModel(-459818001), new GTA.Math.Vector3(1762.698f, 3342.431f, 41.06026f), -21.99943f);
                    Meth.upgrade10ped2 = GTA.World.CreatePed(RequestModel(-2077218039), new GTA.Math.Vector3(1762.708f, 3343.792f, 41.01034f), -168.9985f);
        ...
        public List<MethLabGuard> MethLabGuards = new List<MethLabGuard>();
        public bool CreatedmethlabGuards;

        public class MethLabGuard
        {
            ...
            public bool IsMovingBackToOriginalPos { get; set; }
            public int MoveTimer { get; set; }
            public MethLabGuard()
            {

            }
            public MethLabGuard(Ped G, Vector3 P,float H)
            {
                IsAttackingTarget = false;
                IsMovingBackToOriginalPos = false;
                   Guard = G;
                OriginalPos = P;
                OriginalHeading = H;
            }
        }
        public List<Ped> GuardPeds = new List<Ped>();
        public List<Ped> AttackingPeds = new List<Ped>();
        public Ped GetClosestAttackingPed(Ped Guard)
        {
            Ped Target=null;
            float dist = 9999;
            foreach (Ped P in AttackingPeds)
            {
                if (P.IsAlive == true)
                {
                    if (P.Position.DistanceTo(Guard.Position) < dist)
                    {
                        Target = P;
                           dist = P.Position.DistanceTo(Guard.Position);
                    }
                }
        ...
        {
            if (perk8methlabguards == true)
            {
                if (Game.Player.Character.Position.DistanceTo(Lab_LiquorAce) < 200)
                {
                    if (CreatedmethlabGuards == false)
                    {
                        GuardPeds.Clear();
                        foreach (MethLabGuard P in MethLabGuards)
                        {
                        ...
                        CreatedmethlabGuards = true;
                        Ped Ped = World.CreatePed(RequestModel(261586155), new Vector3(1392.036f, 3598.557f, 35.0f), -157f);
                        MethLabGuards.Add(new MethLabGuard(Ped, Ped.Position, Ped.Heading));
                        Ped = World.CreatePed(RequestModel(261586155), new Vector3(1410.84f, 3606.75f, 39.00f), -132f);
                        MethLabGuards.Add(new MethLabGuard(Ped, Ped.Position, Ped.Heading));
                        Ped = World.CreatePed(RequestModel(261586155), new Vector3(1394.70f, 3623.56f, 35.01f), 24f);
                        MethLabGuards.Add(new MethLabGuard(Ped, Ped.Position, Ped.Heading));
                        Ped = World.CreatePed(RequestModel(261586155), new Vector3(1395.43f, 3611.025f, 34.98f), -58f);
                        MethLabGuards.Add(new MethLabGuard(Ped, Ped.Position, Ped.Heading));
                        foreach (MethLabGuard G in MethLabGuards)
                        {
                            GuardPeds.Add(G.Guard);
                            if (G.Guard != null)
                            {
                                RelationshipGroup EnemyRelationShipGroup = Game.Player.Character.RelationshipGroup;
                                G.Guard.Weapons.Give(WeaponHash.AssaultrifleMk2, 9999, true, true);
                                G.Guard.Weapons.Select(WeaponHash.AssaultrifleMk2, true);
                                Function.Call(Hash.SET_PED_RELATIONSHIP_GROUP_HASH, G.Guard, EnemyRelationShipGroup);
                                Function.Call(Hash.SET_PED_COMBAT_ATTRIBUTES, G.Guard, 0, 0);
                                Function.Call(Hash.SET_BLOCKING_OF_NON_TEMPORARY_EVENTS, G.Guard, 1);
                                G.Guard.Health = 300;
                                G.Guard.CanRagdoll = false;
                                G.Guard.CanWrithe = false;
                            }
                        }

                    }
                    if (CreatedmethlabGuards == true)
                    {
                        int Group = Function.Call<int>(Hash.GET_PED_GROUP_INDEX, Game.Player.Character);
                        List<Ped> Bodyguards = new List<Ped>();
                        for (int i = 0; i < 8; i++)
                        {
                            Ped b = Function.Call<Ped>(Hash.GET_PED_AS_GROUP_MEMBER, Group, i);
                            if (b != null)
                            {
                                if (Bodyguards.Contains(b))
                                {
                                    Bodyguards.Add(b);
                                }
                        ...
                        Ped[] nearbypeds = World.GetNearbyPeds(Lab_LiquorAce, 200f);
                        foreach (Ped N in nearbypeds)
                        {
                            if (N != Game.Player.Character && N.RelationshipGroup != Game.Player.Character.RelationshipGroup)
                            {

                                if (!Bodyguards.Contains(N))
                                {
                                    if (N.IsAlive == true)
                                    {
                                        if (N.IsInCombatAgainst(Game.Player.Character))
                                        {
                                            if (!AttackingPeds.Contains(N))
                                            {
                                                AttackingPeds.Add(N);
                                            }
                                        ...
                                        if (GuardPeds.Contains(Function.Call<Entity>((Hash)0x32C27A11307B01CC, N, 1)))
                                        {
                                            if (!AttackingPeds.Contains(N))
                                            {
                                                AttackingPeds.Add(N);
                        ...
                        foreach (MethLabGuard G in MethLabGuards)
                        {
                            ...
                            if (G.IsAttackingTarget == false)
                            {
                                Ped ClosestAttackingPed = GetClosestAttackingPed(G.Guard);
                                if (ClosestAttackingPed != null)
                                {
                                    G.Target = ClosestAttackingPed;

                                    G.Guard.Task.FightAgainst(ClosestAttackingPed);
                                    G.IsAttackingTarget = true;
                                }
                                else
                                {
                                    G.IsAttackingTarget = false;
                                    G.IsMovingBackToOriginalPos = true;
                                }

                            }
                            if (G.Guard.IsAlive == true)
                            {
                                if (G.IsAttackingTarget == true)
                                {
                                    if (G.Target.IsAlive == true)
                                    {
                                        if (G.MoveTimer <= 24)
                                        {
                                            G.MoveTimer++;
                                        ...
                                        {
                                            G.MoveTimer = 0;
                                            G.Guard.Task.FightAgainst(G.Target);
                                        }
                                    }
                                    if (G.Target.IsAlive == false)
                                    {
                                        G.IsMovingBackToOriginalPos = true;
                                        G.IsAttackingTarget = false;
                                    }
                                ...
                                if (G.IsMovingBackToOriginalPos == true)
                                {
                                    if (G.IsAttackingTarget == false)
                                    {
                                        Ped ClosestAttackingPed = GetClosestAttackingPed(G.Guard);
                                        if (ClosestAttackingPed != null)
                                        {
                                            ...
                                            G.Guard.Task.FightAgainst(ClosestAttackingPed);
                                            G.IsAttackingTarget = true;
                                            G.IsMovingBackToOriginalPos = false;
                                        }

                                    }
                                    if (G.Guard.Position.DistanceTo(G.OriginalPos) >= 1.35f)
                                    {
                                        if (G.MoveTimer <= 38)
                                        {
                                            G.MoveTimer++;
                                        ...
                                        {
                                            Function.Call(Hash.TASK_FOLLOW_NAV_MESH_TO_COORD, G.Guard, G.OriginalPos.X, G.OriginalPos.Y, G.OriginalPos.Z, 1f, 20000, 0.1f, 512, 0);
                                            G.MoveTimer = 0;
                                        }
                                    }
                                    if (G.Guard.Position.DistanceTo(G.OriginalPos) <= 1.35f)
                                    {
                                        if (!((G.Guard.Heading - 25) > G.OriginalHeading && (G.Guard.Heading + 25) < G.OriginalHeading))
                                        {
                                            G.Guard.Task.AchieveHeading(G.OriginalHeading);
                                        }
            ...
            if (Game.IsControlJustPressed( (GTA.Control)activate_key))//E
            {
                ...
                if (Meth.OnSupply == 1)
                {
                    if (Meth.Supplier == 1)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.supply1location) < 1.5)
                        {
                            ...
                            pickupSupplies();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, supply1ped1, "GENERIC_THANKS", "G_M_Y_STREETPUNK02_BLACK_MINI_04", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    else if (Meth.Supplier == 2)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.supply2location) < 1.5)
                        {
                            ...
                            pickupSupplies();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, supply1ped2, "GENERIC_THANKS", "A_M_M_HillBilly_02_WHITE_MINI_02", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                }
                ...
                if (Meth.OnDeal == 1)
                {
                    ...
                    if (Meth.Customer == 1)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal1location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal1ped1, voiceid, "A_M_M_HILLBILLY_02_WHITE_MINI_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 2)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal2location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal2ped1, voiceid, "A_M_M_TRAMP_01_BLACK_MINI_01", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 3)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal3location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal3ped1, voiceid, "A_F_Y_EastSA_03_Latino_FULL_01", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 4)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal4location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal4ped1, voiceid, "A_M_M_HILLBILLY_02_WHITE_MINI_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 5)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal5location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal5ped1, voiceid, "A_M_M_HILLBILLY_02_WHITE_MINI_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 6)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal6location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal6ped1, voiceid, "A_M_M_TRAMP_01_BLACK_MINI_01", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 7)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal7location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal7ped1, voiceid, "A_M_Y_BeachVesp_01_White_Mini_01", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 8)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal8location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal8ped1, voiceid, "A_M_M_HILLBILLY_02_WHITE_MINI_04", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 9)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal9location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal9ped1, voiceid, "A_M_M_HILLBILLY_02_WHITE_MINI_03", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 10)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal10location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal10ped1, voiceid, "A_M_M_HILLBILLY_02_WHITE_MINI_04", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 11)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal11location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal11ped1, voiceid, "S_F_M_FEMBARBER_BLACK_MINI_01", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 12)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal12location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal12ped1, voiceid, "G_M_Y_LOST_03_WHITE_FULL_01", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 13)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal13location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal13ped1, voiceid, "A_M_M_HillBilly_02_WHITE_MINI_02", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 14)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal14location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal14ped1, voiceid, "G_M_M_ARMLIEUT_01_WHITE_ARMENIAN_MINI_01", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                    if (Meth.Customer == 15)
                    {
                        if (Game.Player.Character.Position.DistanceTo(Meth.deal15location) < 1.5f)
                        {
                            ...
                            sellToCustomer();
                            GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, deal15ped1, voiceid, "A_M_M_HillBilly_02_WHITE_MINI_02", "SPEECH_PARAMS_FORCE_SHOUTED", 0);
                        }
                    }
                }
                ...
                if (OnUpgrade == 1 && UpgradeMission == 8)
                {
                    if (Game.Player.Character.CurrentVehicle != null && Game.Player.Character.CurrentVehicle.Model.Hash == 744705981 && Game.Player.Character.IsInVehicle(upgrade8vehicle1) && Game.GameTime > upgrade8dropwait)
                    {
                        ...
                        Vector3 rot = new GTA.Math.Vector3(0f, 0f, 0f);
                        Model model = RequestModel(-1319782883);
                        model.Request(10000);
            ...
            if (OnUpgrade == 1)
            {
                ...
                if (UpgradeMission == 3)
                {
                    ...
                    if (upgrade3_part == 1)
                    {
                        ...
                        if (Game.Player.Character.Position.DistanceTo(Meth.upgrade3_marker1) < 20)
                        {
                            ...
                            if (chooser == 1)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "GENERIC_HI", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 2)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "GENERIC_THANKS", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 3)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "GENERIC_HOWS_IT_GOING", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 4)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "CHAT_RESP", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 5)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "CHAT_STATE", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 6)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "NICE_CAR_THANKS", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 7)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "PHONE_CONV1_CHAT1", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 8)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "PHONE_CONV4_CHAT2", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 9)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "SUSPECT_KILLED", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 10)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "PHONE_CONV1_CHAT2", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 11)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "PHONE_CONV3_CHAT1", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 12)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped2, "PHONE_CONV4_CHAT1", "G_M_M_MEXBOSS_02_LATINO_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            chooser = rnd.Next(1, 2500);
                            if (chooser == 1)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "GENERIC_HI", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 2)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "GENERIC_THANKS", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 3)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "GENERIC_HOWS_IT_GOING", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 4)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "CHAT_RESP", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 5)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "CHAT_STATE", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 6)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "NICE_CAR_THANKS", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 7)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "PHONE_CONV1_CHAT1", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 8)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "PHONE_CONV4_CHAT2", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 9)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "SUSPECT_KILLED", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 10)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "PHONE_CONV1_CHAT2", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 11)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "PHONE_CONV3_CHAT2", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                            else if (chooser == 12)
                            {
                                GTA.Native.Function.Call(Hash.PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE, upgrade3ped6, "PHONE_CONV4_CHAT1", "G_M_Y_SALVABOSS_01_SALVADORIAN_MINI_01", "SPEECH_PARAMS_FORCE", 0);
                            }
                        }
                ...
                if (UpgradeMission == 6)
                {
                    ...
                    if (upgrade6_part == 1) //Get player in to Hydra
                    {
                        ...
                        {
                            upgrade6_part = 2;
                            Meth.upgrade6vehicle2 = GTA.World.CreateVehicle(RequestModel(-1745203402), new GTA.Math.Vector3(1948.743f, 4634.548f, 40.38613f), 104.4526f); //First blam vans
                            Meth.upgrade6vehicle3 = GTA.World.CreateVehicle(RequestModel(-1745203402), new GTA.Math.Vector3(1942.434f, 4642.946f, 40.44304f), -111.1778f); //First blam vans
                            upgrade6ped1 = GTA.World.CreatePed(RequestModel(32417469), new GTA.Math.Vector3(1946.133f, 4637.589f, 40.56693f), -117.0881f);
                            upgrade6ped2 = GTA.World.CreatePed(RequestModel(2119136831), new GTA.Math.Vector3(1947.532f, 4638.259f, 40.57524f), 169.8764f);
                            upgrade6ped3 = GTA.World.CreatePed(RequestModel(-1176698112), new GTA.Math.Vector3(1946.497f, 4636.374f, 40.54762f), -38.9992f);
                            upgrade6ped4 = GTA.World.CreatePed(RequestModel(-1463670378), new GTA.Math.Vector3(1941.803f, 4640.667f, 40.64164f), -164.6121f);
                    ...
                    if (upgrade6_part == 2) //Get player to kill scene 1
                    {
                        if (upgrade6vehicle2.IsDriveable != true && upgrade6vehicle3.IsDriveable != true)
                        {
                            ...
                            upgrade6_part = 3;
                            Meth.upgrade6vehicle4 = GTA.World.CreateVehicle(RequestModel(80636076), new GTA.Math.Vector3(2547.894f, 4680.112f, 33.19466f), -5.378663f);
                            Meth.upgrade6vehicle5 = GTA.World.CreateVehicle(RequestModel(65402552), new GTA.Math.Vector3(2561.425f, 4685.439f, 33.60718f), 101.3645f); //Second blam van
                            upgrade6ped5 = GTA.World.CreatePed(RequestModel(1822107721), new GTA.Math.Vector3(2567.556f, 4684.499f, 34.05129f), -6.697811f);
                            upgrade6ped6 = GTA.World.CreatePed(RequestModel(2064532783), new GTA.Math.Vector3(2567.56f, 4685.728f, 34.05129f), -166.8609f);
                    ...
                    if (upgrade6_part == 3) //Get player to kill scene 2
                    {
                        if (upgrade6vehicle5.IsDriveable != true)
                        {
                            ...
                            upgrade6_part = 4;
                            Meth.upgrade6vehicle6 = GTA.World.CreateVehicle(RequestModel(-2140210194), new GTA.Math.Vector3(2917.972f, 4635.191f, 48.74606f), -48.54824f);
                            Meth.upgrade6vehicle7 = GTA.World.CreateVehicle(RequestModel(-2140210194), new GTA.Math.Vector3(2923.577f, 4631.33f, 48.73765f), -39.45861f);
                            Meth.upgrade6vehicle8 = GTA.World.CreateVehicle(RequestModel(1518533038), new GTA.Math.Vector3(2947.058f, 4641.889f, 48.77872f), -13.05195f);
                    ...
                    if (upgrade6_part == 4) //Get player to kill scene 3
                    {
                        if (upgrade6vehicle6.IsDead && upgrade6vehicle7.IsDead)
                        {
                            ...
                            UpgradeMission6Cleanup();
                            upgrade6_part = 5;
                            Meth.upgrade6vehicle9 = GTA.World.CreateVehicle(RequestModel(356391690), new GTA.Math.Vector3(2312.197f, 3230.673f, 47.00118f), 66.52007f);
                            upgrade6ped7 = GTA.World.CreatePed(RequestModel(1768677545), new GTA.Math.Vector3(2323.524f, 3228.144f, 47.8897f), -73.93405f);
                ...
                if (UpgradeMission == 9)
                {
                    ...
                    if (upgrade9_part == 1) //Get player to catch up with Boxville
                    {
                        ...
                        {
                            Meth.upgrade9vehicle1 = GTA.World.CreateVehicle(RequestModel(-2052737935), new GTA.Math.Vector3(1925.598f, 2996.304f, 45.88427f), -172.3694f); //Truck
                            Meth.upgrade9vehicle2 = GTA.World.CreateVehicle(RequestModel(666166960), new GTA.Math.Vector3(1921.15f, 3013.439f, 45.65034f), 178.5073f); //Baller 1
                            Meth.upgrade9vehicle3 = GTA.World.CreateVehicle(RequestModel(666166960), new GTA.Math.Vector3(1928.403f, 3021.375f, 45.58162f), 172.4146f); //Baller 2

                            //Convoy peds
                            Meth.upgrade9ped1 = GTA.World.CreatePed(RequestModel(-245247470), new GTA.Math.Vector3(1919.082f, 3012.946f, 45.69437f), 44.29706f);
                            Meth.upgrade9ped2 = GTA.World.CreatePed(RequestModel(691061163), new GTA.Math.Vector3(1918.451f, 3014f, 45.66372f), -155.9632f);
                            Meth.upgrade9ped3 = GTA.World.CreatePed(RequestModel(691061163), new GTA.Math.Vector3(1930.738f, 3022.008f, 45.89248f), -162.0043f);
                            Meth.upgrade9ped5 = GTA.World.CreatePed(RequestModel(-245247470), new GTA.Math.Vector3(1930.876f, 3020.877f, 45.8495f), -9.943027f);
                            Meth.upgrade9ped4 = GTA.World.CreatePed(RequestModel(988062523), new GTA.Math.Vector3(1928.8f, 2994.656f, 45.63882f), -158.9522f);
                            Meth.upgrade9ped6 = GTA.World.CreatePed(RequestModel(-1395868234), new GTA.Math.Vector3(1929.126f, 2993.697f, 45.62851f), -5.999521f);
                            //Heli peds
                    ...
                    if (upgrade9_part == 3) //Stop camera and start convoy
                    {
                        ...
                        if (Game.Player.Character.IsInVehicle(upgrade9vehicle1))
                        {
                            ...
                            {
                                Meth.upgrade9vehicle5 = GTA.World.CreateVehicle(RequestModel(470404958), new GTA.Math.Vector3(1777.544f, 3308.539f, 41.16642f), -72.05384f);
                                Meth.upgrade9ped11 = GTA.World.CreatePed(RequestModel(-245247470), new GTA.Math.Vector3(1778.385f, 3307.053f, 41.28271f), -159.6325f);
                                Meth.upgrade9ped12 = GTA.World.CreatePed(RequestModel(691061163), new GTA.Math.Vector3(1777.461f, 3306.595f, 41.2655f), -135.9882f);
                            ...
                            {
                                Meth.upgrade9vehicle6 = GTA.World.CreateVehicle(RequestModel(666166960), new GTA.Math.Vector3(1717.183f, 3594.836f, 35.1977f), -154.9598f);
                                Meth.upgrade9ped13 = GTA.World.CreatePed(RequestModel(-1395868234), new GTA.Math.Vector3(1715.082f, 3593.37f, 35.35431f), -151.9995f);
                                Meth.upgrade9ped14 = GTA.World.CreatePed(RequestModel(653289389), new GTA.Math.Vector3(1715.468f, 3592.61f, 35.33712f), 27.9999f);
                            ...
                            {
                                Meth.upgrade9vehicle4 = GTA.World.CreateVehicle(RequestModel(837858166), new GTA.Math.Vector3(1983.284f, 3036.982f, 47.44331f), 59.03642f);

                                Meth.upgrade9ped7 = GTA.World.CreatePed(RequestModel(-1395868234), new GTA.Math.Vector3(1980.491f, 3034.839f, 47.05631f), 45.00013f);
                                Meth.upgrade9ped8 = GTA.World.CreatePed(RequestModel(988062523), new GTA.Math.Vector3(1979.426f, 3035.513f, 47.05631f), -100.9994f);
                                Meth.upgrade9ped9 = GTA.World.CreatePed(RequestModel(691061163), new GTA.Math.Vector3(1984.852f, 3039.936f, 47.05617f), 80.05302f);
                                Meth.upgrade9ped10 = GTA.World.CreatePed(RequestModel(-245247470), new GTA.Math.Vector3(1983.167f, 3040.877f, 47.05618f), -128.9991f);
                ...
                if (UpgradeMission == 10)
                {
                    ...
                    if (upgrade10_part == 1)
                    {
                        ...
                        {
                            Meth.upgrade10ped3 = GTA.World.CreatePed(RequestModel(-398748745), new GTA.Math.Vector3(1994.827f, 3053.504f, 47.21453f), -21.30706f);
                    ...
                    if (upgrade10_part == 2)
                    {
                        if (upgrade10ped3.IsDead)
                        {
                            ...
                            Meth.upgrade10vehicle2 = GTA.World.CreateVehicle(RequestModel(1770332643), new GTA.Math.Vector3(1576.751f, 2903.855f, 56.57074f), 178.4581f);
                            Meth.upgrade10vehicle3 = GTA.World.CreateVehicle(RequestModel(1762279763), new GTA.Math.Vector3(1581.466f, 2886.678f, 56.83314f), 45.17765f);
                            Meth.upgrade10ped4 = GTA.World.CreatePed(RequestModel(866411749), new GTA.Math.Vector3(1579.237f, 2901.583f, 56.91332f), -148.9984f);
                            Meth.upgrade10ped5 = GTA.World.CreatePed(RequestModel(1309468115), new GTA.Math.Vector3(1579.65f, 2900.247f, 56.94117f), 17.99991f);
                            Meth.upgrade10ped6 = GTA.World.CreatePed(RequestModel(-2077218039), new GTA.Math.Vector3(1580.543f, 2901.413f, 56.91584f), 126.5827f);
                    ...
                    if (upgrade10_part == 3)
                    {
                        if (upgrade10ped4.IsDead && upgrade10ped5.IsDead && upgrade10ped6.IsDead)
                        {
                            ...
                            Meth.upgrade10vehicle4 = GTA.World.CreateVehicle(RequestModel(-1372848492), new GTA.Math.Vector3(1092.67f, 2658.324f, 37.57644f), 150.1183f);
                            Meth.upgrade10ped7 = GTA.World.CreatePed(RequestModel(-2077218039), new GTA.Math.Vector3(1097.013f, 2659.271f, 38.14315f), 153.9186f);
                            Meth.upgrade10ped8 = GTA.World.CreatePed(RequestModel(42647445), new GTA.Math.Vector3(1095.99f, 2658.381f, 38.14215f), -29.31764f); //Hooker prop
                            Meth.upgrade10ped9 = GTA.World.CreatePed(RequestModel(348382215), new GTA.Math.Vector3(1096.974f, 2658.089f, 38.14336f), 6.391753f); //Hooker prop
            ...
            if (Game.Player.Character.IsAlive == false)
            {
                ...
                if (Game.Player.Character.Killer != null)
                {
                    killerHash = Game.Player.Character.Killer.Model.GetHashCode();
                }
            }
            ...
            if (Game.Player.Character.IsAlive == true && WasBeingRobbed == 1 && TriggerPedCheck == 1)
            {
                ...
                if (dealPeds.Contains(Game.Player.Character.Killer))
                {
        ...
        public void upgrade8BlipNext(Vector3 location)
        {
            ...
            Vector3 rot = new GTA.Math.Vector3(0f, 0f, 0f);
            Model model = RequestModel(-1564193152);
            model.Request(10000);
        ...
        public void perk7CookSpawn()
        {
            if (perk7hirecooks)
            {
                Meth.perk7ped1 = GTA.World.CreatePed(RequestModel(-610530921), new GTA.Math.Vector3(1388.107f, 3607.953f, 38.94191f), 100.9953f);
                Meth.perk7ped2 = GTA.World.CreatePed(RequestModel(261586155), new GTA.Math.Vector3(1391.6768f, 3606.3030f, 38.94191f), 99.89833f);
        ...
        public void upgradeLabPropSpawn()
        {
            ...
            {
                Model model = RequestModel(-566369276);
                //model.Request(10000);
            ...
            {
                Model model = RequestModel(-921781850);
            ...
            {
                Model model = RequestModel(-1344435013);
            ...
            {
                Model model = RequestModel(-1181704684);
            ...
            {
                Model model = RequestModel(-1197050094);
            ...
            {
                Model model = RequestModel(505870426);
            ...
            {
                Model model = RequestModel(-406357375);
            ...
            {
                Model model = RequestModel(-1088738506);
            ...
            {
                Model model = RequestModel(1876827312);
            ...
            {
                Model model = RequestModel(2138646444);
            ...
            {
                Model model = RequestModel(2094829076);
                Model model2 = RequestModel(936543891);
            ...
            {
                Model model = RequestModel(628478833);
        ...
        public static void triggerLabRaid()
        {
            ...
            labraidped1 = GTA.World.CreatePed(RequestModel(pedmodel1), new GTA.Math.Vector3(1402.08f, 3627.701f, 34.89277f), 19.21337f);
            labraidped2 = GTA.World.CreatePed(RequestModel(pedmodel2), new GTA.Math.Vector3(1400.131f, 3626.995f, 34.89279f), 38.00013f);
            labraidped3 = GTA.World.CreatePed(RequestModel(pedmodel3), new GTA.Math.Vector3(1400.21f, 3628.284f, 34.89402f), -154.998f);
            labraidped4 = GTA.World.CreatePed(RequestModel(pedmodel4), new GTA.Math.Vector3(1385.788f, 3605.574f, 34.89447f), 133.0008f);
            labraidped5 = GTA.World.CreatePed(RequestModel(pedmodel5), new GTA.Math.Vector3(1384.74f, 3604.854f, 34.89449f), -71.99965f);

            chooser = rnd.Next(1, 4);
            if (chooser == 1)
            {
                labraidped6 = GTA.World.CreatePed(RequestModel(pedmodel6), new GTA.Math.Vector3(1408.832f, 3607.901f, 39.00307f), 55.99979f);
                labraidped7 = GTA.World.CreatePed(RequestModel(pedmodel7), new GTA.Math.Vector3(1398.678f, 3599.166f, 35.00398f), 0f);
                labraidped8 = GTA.World.CreatePed(RequestModel(pedmodel8), new GTA.Math.Vector3(1400.954f, 3599.963f, 35.03451f), 17.99998f);
            }
            if (chooser == 2)
            {
                labraidped6 = GTA.World.CreatePed(RequestModel(pedmodel6), new GTA.Math.Vector3(1408.832f, 3607.901f, 39.00307f), 55.99979f);
                labraidped7 = GTA.World.CreatePed(RequestModel(pedmodel7), new GTA.Math.Vector3(1406.239f, 3601.248f, 34.98925f), 17.99998f);
                labraidped8 = GTA.World.CreatePed(RequestModel(pedmodel8), new GTA.Math.Vector3(1380.178f, 3620.944f, 34.89181f), 80.99962f);
            }
            if (chooser == 3)
            {
                labraidped6 = GTA.World.CreatePed(RequestModel(pedmodel6), new GTA.Math.Vector3(1400.954f, 3599.963f, 35.03451f), 17.99998f);
                labraidped7 = GTA.World.CreatePed(RequestModel(pedmodel7), new GTA.Math.Vector3(1398.678f, 3599.166f, 35.00398f), 0f);
                labraidped8 = GTA.World.CreatePed(RequestModel(pedmodel8), new GTA.Math.Vector3(1409.052f, 3619.092f, 34.89446f), -66.99969f);
            }
        ...
        public static void sellToCustomer()
        {
            ...
            Vector3 rot = new GTA.Math.Vector3(1388.729f, 3613.192f, 42.63286f);
            Model model = RequestModel(285917444);
            model.Request(10000);
            ...
            AttachEntityToEntity(methbagprop, GTA.Game.Player.Character, GTA.Game.Player.Character.Bones[Bone.IKRightHand].Index, new Vector3(0.1430f, 0.0390f, 0f), new Vector3(-45.127f, 8f, 0f), false, false, false, 2, true);
        ...
        public void cookmeth()
        {
            ...
            else
            {
                ...
                Game.Player.Character.Task.PlayAnimation("anim@amb@business@meth@meth_monitoring_cooking@cooking@", "look_around_v1_cooker", 1f,1f, 11500, AnimationFlags.None, -1f);
                Script.Wait(6000);
                GTA.UI.Screen.FadeOut(1000);
                Script.Wait(3000);
                if (cookSmallTimeDay == 1)
                {
                    GTA.World.CurrentTimeOfDay = GTA.World.CurrentTimeOfDay.Add(TimeSpan.FromHours(12));
                }
        ...
        public static void cookmethverylarge(int Supplies)
        {
            Meth.TimerCounterAutoBatch = 0;
            Meth.CookingCooldown = 1;
            large2BatchStart = 1;
            TimerTarget = Supplies * 2000;
            currentSupplies = currentSupplies - Supplies;
        ...
        public static void autoBatchFinished(string mode)
        {
            ...
            if (mode == "elarge")
            {
                int batchgrams = rnd.Next(cookLargeGramsMin * 10, cookLargeGramsMax * 10 + 1);
                currentGrams = currentGrams + batchgrams;
                saveStats();
                GTA.UI.Notification.Show("extremely large batch finished! This cook produced ~g~" + batchgrams.ToString() + "g ~w~of ~r~meth.");
            }
            if (mode == "mlarge")
            {
                int batchgrams = rnd.Next(cookLargeGramsMin * 15, cookLargeGramsMax * 15 + 1);
                currentGrams = currentGrams + batchgrams;
                saveStats();
                GTA.UI.Notification.Show("mega batch finished! This cook produced ~g~" + batchgrams.ToString() + "g ~w~of ~r~meth.");
            }
            if (mode == "ularge")
            {
                int batchgrams = rnd.Next(cookLargeGramsMin * 20, cookLargeGramsMax * 20 + 1);
                currentGrams = currentGrams + batchgrams;
                saveStats();
                GTA.UI.Notification.Show("ultimate batch finished! This cook produced ~g~" + batchgrams.ToString() + "g ~w~of ~r~meth.");
            }
            else
            {
        ...
        public static void startPoliceSetup()
        {
            ...
            setup1vehicle1 = World.CreateVehicle(RequestModel(-1973172295), spawn1, 46.92113f);
            setup1vehicle2 = World.CreateVehicle(RequestModel(-1973172295), spawn2, 46.92113f);
            setup1vehicle3 = World.CreateVehicle(RequestModel(-1973172295), spawn3, 46.92113f);

            setup1ped1 = World.CreatePed(RequestModel(1581098148), setup1vehicle1.Position, -100.99f);
            setup1ped2 = World.CreatePed(RequestModel(1581098148), setup1vehicle2.Position, 136.3854f);
            setup1ped3 = World.CreatePed(RequestModel(1581098148), setup1vehicle3.Position, 136.3854f);
            ...
            setup1vehicle1.IsSirenActive = true;
            setup1vehicle2.IsSirenActive = true;
            setup1vehicle3.IsSirenActive = true;
